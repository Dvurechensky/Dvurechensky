...
<div align="center" style="margin: 20px 0; padding: 10px; background: #1c1917; border-radius: 10px;">
  ...
  <a href="/Dvurechensky/" style="color: #0891b2; margin: 0 10px;">Main EN</a>
  |
  <a href="/Dvurechensky/rnd.ru.html" style="color: #F5F752; margin: 0 10px;">R&D RU</a>
</div>

<div align="center" style="margin: 20px 0; padding: 10px; background: #1c1917; border-radius: 10px;">
  <strong>🌐 Language: </strong>
  
  <a href="/Dvurechensky/rnd.ru.html" style="color: #F5F752; margin: 0 10px;">
    🇷🇺 Russian
  </a>
  | 
